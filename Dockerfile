...
# Run:   docker run -p 8000:8000 --env-file .env 22pm-engine

FROM python:3.12-slim AS base

# Environment configurations (Fixed syntax)
...
# Ensure the .env file is copied if it exists in the build context
COPY .env* ./ 
...
# Run with uvicorn
CMD ["uvicorn", "main:app", "--host", "0.0.0.0", "--port", "8000", "8080", "3000" ...]
